...
|---------|------|-----------|-------------------|
| **🔥 1순위** | **변수와 데이터 타입** | let, const (var 사용 금지)<br>원시타입 vs 참조타입<br>불변성 개념<br>[스코프](/code/2025-06-16-javascript-scope/)<br>[호이스팅](/code/2025-06-25-javascript-hoisting/) | 상태 관리의 기초<br>props 전달 이해 |

...
description: >
  각 이미지의 제목과 진행 표시줄을 나타내는 slick slider 코드 예제
keywords: > 
  slick.js, slick slider, progress bar, 진행 표시줄
sitemap: true
comments: false
---
...
.slider {font-size: 0;}
.slider .list {position: relative;overflow:hidden;width: 100%;height: 600px;}
.slider .list img {position: absolute;top:0;left:0;width: 100%;height: 100%;object-fit: cover;}

/* 진행 표시줄 */
.progress {display: flex;position: absolute;left: 50%;bottom: 0;width:1180px;max-width: 100%;transform: translate(-50%, 0);background: rgba(0,0,0,0.7);text-align: center;}
...
.progress > li.active .bar {animation-name: countingBar;animation:countingBar 3.5s linear forwards;}
